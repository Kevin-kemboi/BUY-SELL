...
const ProductCard = ({ product }) => {
  return (
    <div className="bg-dark-2 flex flex-col items-center text-justify justify-center px-7 rounded-lg w-full text-dark-5 max-sm:px-3 overflow-hidden max-h-[280px]">
      {product.imageUrl ? (
