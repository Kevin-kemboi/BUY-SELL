        ...
        {products.length > 0 ? (
          products.map((product) => (
            ...
            >
              ...
              />
              <div className="z-5 absolute bottom-2 left-0 mx-2 flex gap-1 border border-light-2/20 pl-3 pr-1 py-1 rounded-full bg-zinc-600/10 backdrop-blur-lg backdrop-saturate-100">
